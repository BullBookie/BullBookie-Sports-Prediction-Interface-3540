  ...
  return (
    <div className="w-full max-w-none">
      <div className="space-y-6">
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center space-x-3 flex-1 min-w-0">
                <SafeIcon icon={FiCalendar} className="w-5 h-5 text-bull-red flex-shrink-0" />
        ...
        {/* Matchweek Cards - Full Width Grid */}
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4 flex-1 min-w-0">
                            <div className="text-bull-light-gray text-sm font-medium w-8 flex-shrink-0">
                              {matchIndex + 1}
                            </div>
                            <div className="flex-1 min-w-0">
                              <div className="text-bull-white font-medium text-sm truncate">
        ...
        <div className="flex justify-center space-x-6 text-xs text-bull-light-gray">
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 border-2 border-bull-red bg-bull-red text-bull-white rounded-bull text-xs flex items-center justify-center font-bold">1</div>
            <span>Home Win</span>
          </div>
          <div className="flex items-center space-x-1">
          ...
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 border-2 border-bull-red bg-bull-red text-bull-white rounded-bull text-xs flex items-center justify-center font-bold">2</div>
            <span>Away Win</span>
          </div>
        </div>
      </div>
